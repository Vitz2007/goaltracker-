            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .navigationBarTrailing) {
                    Button("common.done") {
                        ...
                        // ✅ THIS IS THE FIX: Call the new, corrected notification functions
                        if goal.reminderIsEnabled {
                            NotificationManager.scheduleNotification(id: goal.id, title: goal.title, reminderDate: goal.reminderDate, reminderIsEnabled: goal.reminderIsEnabled)
                        } else {
                            NotificationManager.cancelNotification(for: goal.id)
                        }
